...
export interface VerifiedParamDef {
  ...
  transform?: "dbThresholdToLinear" | "khzToHzIfNeeded";
}
...
export const AT5_VERIFIED_GEAR: VerifiedGearDef[] = [
  {
    ...
    params: [
      { friendlyName: "Sensitivity", xmlName: "Sensitivity_JCM800AT4", min: 0, max: 1, aliases: ["sensitivity", "hi lo", "input"] },
  ...
  },
  {
    ...
    preferredSection: "AmpA",
    params: [
      { friendlyName: "Gain", xmlName: "Gain_BritishTubeLead1", min: 0, max: 10, aliases: ["gain", "preamp_gain", "drive"] },
      { friendlyName: "Bass", xmlName: "Bass_BritishTubeLead1", min: 0, max: 10, aliases: ["bass"] },
      { friendlyName: "Mid", xmlName: "Mid_BritishTubeLead1", min: 0, max: 10, aliases: ["middle", "mid"] },
      { friendlyName: "Treble", xmlName: "Treble_BritishTubeLead1", min: 0, max: 10, aliases: ["treble"] },
      { friendlyName: "Presence", xmlName: "Presence_BritishTubeLead1", min: 0, max: 10, aliases: ["presence"] },
      { friendlyName: "Reverb", xmlName: "Reverb_BritishTubeLead1", min: 0, max: 10, aliases: ["reverb"] },
      { friendlyName: "Volume", xmlName: "Volume_BritishTubeLead1", min: 0, max: 10, aliases: ["volume", "master", "output"] },
    ],
  },
  {
    name: "Noise Gate",
    ...
    params: [
      ...
      { friendlyName: "Depth", xmlName: "Depth", min: -100, max: -20, unit: "dB", aliases: ["depth", "reduction"] },
    ],
  },
  {
    name: "OverScream",
  ...
  },
  {
    ...
    preferredSection: "RackA",
    params: [
      { friendlyName: "Band 20", xmlName: "Band20", min: -15, max: 15, aliases: ["20Hz", "20 hz"] },
      { friendlyName: "Band 25", xmlName: "Band25", min: -15, max: 15, aliases: ["25Hz", "25 hz"] },
      { friendlyName: "Band 31", xmlName: "Band31", min: -15, max: 15, aliases: ["31Hz", "31 hz", "31.5Hz", "31.5 hz"] },
      { friendlyName: "Band 40", xmlName: "Band40", min: -15, max: 15, aliases: ["40Hz", "40 hz"] },
      { friendlyName: "Band 50", xmlName: "Band50", min: -15, max: 15, aliases: ["50Hz", "50 hz"] },
      { friendlyName: "Band 63", xmlName: "Band63", min: -15, max: 15, aliases: ["63Hz", "63 hz"] },
      { friendlyName: "Band 80", xmlName: "Band80", min: -15, max: 15, aliases: ["80Hz", "80 hz"] },
      { friendlyName: "Band 100", xmlName: "Band100", min: -15, max: 15, aliases: ["100Hz", "100 hz"] },
      { friendlyName: "Band 125", xmlName: "Band125", min: -15, max: 15, aliases: ["125Hz", "125 hz"] },
      { friendlyName: "Band 160", xmlName: "Band160", min: -15, max: 15, aliases: ["160Hz", "160 hz"] },
      { friendlyName: "Band 200", xmlName: "Band200", min: -15, max: 15, aliases: ["200Hz", "200 hz"] },
      { friendlyName: "Band 250", xmlName: "Band250", min: -15, max: 15, aliases: ["250Hz", "250 hz"] },
      { friendlyName: "Band 315", xmlName: "Band315", min: -15, max: 15, aliases: ["315Hz", "315 hz", "320Hz", "320 hz"] },
      { friendlyName: "Band 400", xmlName: "Band400", min: -15, max: 15, aliases: ["400Hz", "400 hz"] },
      { friendlyName: "Band 500", xmlName: "Band500", min: -15, max: 15, aliases: ["500Hz", "500 hz"] },
      { friendlyName: "Band 630", xmlName: "Band630", min: -15, max: 15, aliases: ["630Hz", "630 hz"] },
      { friendlyName: "Band 800", xmlName: "Band800", min: -15, max: 15, aliases: ["800Hz", "800 hz"] },
      { friendlyName: "Band 1000", xmlName: "Band1000", min: -15, max: 15, aliases: ["1000Hz", "1000 hz", "1kHz", "1 khz"] },
      { friendlyName: "Band 1250", xmlName: "Band1250", min: -15, max: 15, aliases: ["1250Hz", "1250 hz", "1.25kHz", "1.25 khz"] },
      { friendlyName: "Band 1600", xmlName: "Band1600", min: -15, max: 15, aliases: ["1600Hz", "1600 hz", "1.6kHz", "1.6 khz"] },
      { friendlyName: "Band 2000", xmlName: "Band2000", min: -15, max: 15, aliases: ["2000Hz", "2000 hz", "2kHz", "2 khz"] },
      { friendlyName: "Band 2500", xmlName: "Band2500", min: -15, max: 15, aliases: ["2500Hz", "2500 hz", "2.5kHz", "2.5 khz"] },
      { friendlyName: "Band 3150", xmlName: "Band3150", min: -15, max: 15, aliases: ["3150Hz", "3150 hz", "3.15kHz", "3.15 khz", "3.2kHz", "3.2 khz"] },
      { friendlyName: "Band 4000", xmlName: "Band4000", min: -15, max: 15, aliases: ["4000Hz", "4000 hz", "4kHz", "4 khz"] },
      { friendlyName: "Band 5000", xmlName: "Band5000", min: -15, max: 15, aliases: ["5000Hz", "5000 hz", "5kHz", "5 khz"] },
      { friendlyName: "Band 6300", xmlName: "Band6300", min: -15, max: 15, aliases: ["6300Hz", "6300 hz", "6.3kHz", "6.3 khz", "6.4kHz", "6.4 khz"] },
      { friendlyName: "Band 8000", xmlName: "Band8000", min: -15, max: 15, aliases: ["8000Hz", "8000 hz", "8kHz", "8 khz"] },
      { friendlyName: "Band 10000", xmlName: "Band10000", min: -15, max: 15, aliases: ["10000Hz", "10000 hz", "10kHz", "10 khz"] },
      { friendlyName: "Band 12500", xmlName: "Band12500", min: -15, max: 15, aliases: ["12500Hz", "12500 hz", "12.5kHz", "12.5 khz"] },
      { friendlyName: "Band 16000", xmlName: "Band16000", min: -15, max: 15, aliases: ["16000Hz", "16000 hz", "16kHz", "16 khz"] },
      { friendlyName: "Band 20000", xmlName: "Band20000", min: -15, max: 15, aliases: ["20000Hz", "20000 hz", "20kHz", "20 khz"] },
      { friendlyName: "Out Level", xmlName: "OutLevel", min: -15, max: 15 },
      { friendlyName: "Mode", xmlName: "Mode_GraphicEQ", min: 0, max: 2, aliases: ["eq_mode"] },
    ],
  },
  {
    name: "Black 76",
    ...
    preferredSection: "RackA",
    params: [
      { friendlyName: "Input", xmlName: "Input", min: 0.0000112202, max: 1, aliases: ["gain"] },
      { friendlyName: "Ratio", xmlName: "Ratio", min: 0, max: 4, aliases: ["ratio"] },
      { friendlyName: "Attack", xmlName: "Attack", min: 1, max: 7 },
      { friendlyName: "Release", xmlName: "Release", min: 1, max: 7 },
      { friendlyName: "Output", xmlName: "Output", min: 0.0000112202, max: 1 },
    ],
  },
  {
